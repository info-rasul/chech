          ...
          <div className="banner5_content h-full w-full flex flex-col gap-[178px] justify-center items-center">
              <div className="banner5_content_block flex w-[100%] justify-between gap-[50px]">
                  <div className="banner5_block flex flex-col gap-[32px] w-[50%]">
                      ...
                      <p className="banner5_desc  block text-[16px] text-black leading-[180%] mt-[-55px] tracking-[0.64px]">
              ...
              <div className="banner5_content_block flex w-[100%] justify-between gap-[50px]">
                  <div className="banner5_block flex flex-col gap-[32px] w-[50%]">
                      ...
                      <p className="banner5_desc  text-[16px] text-black leading-[180%] mt-[-55px] tracking-[0.64px]">
                  ...
                  <div className="banner5_block flex flex-col gap-[32px] w-[50%]">
                      ...
                      <p className="banner5_desc  block text-[16px] text-black leading-[180%] mt-[-52px] tracking-[0.64px]">
