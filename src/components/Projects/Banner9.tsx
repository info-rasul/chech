      ...
      <div className="section banner9 flex p-[70px] bg-[#F1EDDF] gap-[95px]">
          ...
          <div className='banner9_content hero flex flex-col justify-between h-full w-[53%] '>
              <div className="flex flex-col gap-[53px]">
                  <h2 className="banner9_subtitle font-cyrillic mt-[-4px] text-[#000000] text-[48px] uppercase tracking-[1px] leading-[120%]">
                  ...
                  <p className="banner9_desc font-inter text-[black] text-[20px] tracking-[.37px] leading-[160%]">
              ...
              <h1 className="banner9_title font-cyrillic text-[120px] text-[#F00000] mb-[-13px] uppercase tracking-[3.66px] leading-[95%]">
