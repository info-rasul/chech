...
const Banner5 = () => {
  return (
      <div
          className="section banner5 pr-[70px] pl-[75px] pb-[60px]"
          id="projects"
          data-scroll-section
          style={{ backgroundImage: `url(${Banner55})` }}
      >
          <div className="banner5_content h-full w-full flex flex-col gap-[203px] justify-center items-center">
              <div className="banner5_content_block flex w-[100%] justify-between gap-[31px]">
                  <div className="banner5_block flex flex-col gap-[36px] w-[50%]">
                      ...
                      <p className="banner5_desc font-inter block text-[16px] text-black leading-[180%] mt-[-55px] tracking-[-0.1px]">
                          военнослужащих участвовали в осуществлении <br/> депортации,
                          ещё примерно столько же были приведены<br/> в боевую готовность в соседних регионах.
              ...
              <div className="banner5_content_block flex w-[100%] justify-between gap-[31px]">
                  <div className="banner5_block flex flex-col gap-[36px] w-[50%]">
                      ...
                      <p className="banner5_desc font-inter text-[16px] text-black leading-[180%] mt-[-55px] tracking-[-0.1px]">
                  ...
                  <div className="banner5_block flex flex-col gap-[36px] w-[50%]">
                      ...
                      <p className="banner5_desc font-inter block text-[16px] text-black leading-[180%] mt-[-52px] tracking-[-0.1px]">
